...
- Log in with an account and return to the “__*Make Payment*__” page, following the previous steps, to ensure the “__*Full Name*__” and “__*Email*__” fields are already populated with the username and email used to create the account. Also check the message at the bottom states: “__*Save payment details to my profile*__” with a check toggle button next to it.
- Click this toggle button before sending the completed payment form and then return to the “__*Make Payment*__” page, by adding other drinks to the cart, and ensure all fields but the Stripe card field are already filled in. 
## Payment Confirmation Page
- Run the HTML and CSS code used to make the “__*Make Payment*__” page, in the W3C Markup Validation Service and CSS Validation Service respectively and ensure no errors display.
