...
- When logged in, it contains a paragraph stating “__*Save payment details in my profile*__” with “__*my profile*__” written as a link for users to click on and be redirected to the “__*My Profile*__” page where they can enter their personal details here and save them so they can appear as default values in the “__*Make Payment*__” page. This omits the need to type these details again thus, speeding up future purchases. 
- When not logged in, contains the message “__*Create an account or login to save this information*__” with “__*Create an account*__” and “__*login*__” links that take users to the “__*Sign Up*__” and “__*Log In*__” pages respectively. 
...
- Desktop 
    ...
    - Delivery Banner:
        - Run the HTML and CSS code used to make this banner, in the W3C Markup Validation Service and CSS Validation Service respectively and ensure no errors display.
        - Using chrome development tools, open the Slurps home page using both 992x571 and 1200x571 screen sizes.
        - Check the length of the delivery banner doesn't exceed the width of both these screen sizes, causing the text on the banner to overflow out of the banner's range.
        - Ensure the text “__*Deliveries Only*__ __*<del>£35*__ __*£5!*__” 
            is legible and clearly organised, separate from the other banner and navigation bar above.
        - Check the “__*£35*__” 
            price is crossed out and the “__*£5*__” price is highlighted with a light blue background colour and a box shadow so it stands out the most, out of all the text on the banner. 
...
- Open up the home page of the Slurps website and without adding anything to the shopping cart, attempt to brute force the way into the “__*Make Payment*__” page by typing at the end in the web address bar “__*/payment*__”.  Make sure an error message stating that there’s nothing in the cart shows at the top of the screen as only users with items in their shopping cart can access this page.
- Revert back to the home page and then add any three drinks to the shopping cart. Click on the shopping cart icon then, in the “__*Shopping Cart*__” page, click on the “__*PAY*__” button. Make sure the website reverts to the “__*Make Payment*__” page.
...
- As there are no currently logged in accounts, ensure the bottom of the page also states the following: “__*Create an account or login to save this information*__”. 
- Make sure the “__*Create an account*__” and “__*login*__” words are links that when clicked on redirect to the “__*Sign Up*__” and “__*Log In*__” page respectively.
- Log in with an account and return to the “__*Make Payment*__” page, following the previous steps, to ensure the “__*Full Name*__” and “__*Email*__” fields are already populated with the username and email used to create the account. Also check the message at the bottom states: “__*Save payment details in my profile*__” with a “__*my profile*__” link at the end of it.
- Click this “__*my profile*__” link to check the website redirects to the “__*My Profile*__” page. In the “__*My Profile*__” page, enter the word “__*TEST*__” in each field and any random country for the “__*Country*__” field before clicking the “__*UPDATE INFORMATION*__” button. Then return back to the “__*Make Payment*__” page and ensure all fields but the Stripe card field are already filled in. 
## Payment Confirmation Page
- Run the HTML and CSS code used to make the “__*Make Payment*__” page, in the W3C Markup Validation Service and CSS Validation Service respectively and ensure no errors display.
...
- Edit Drink Form:
    ...
    - Check the “__*Price*__” field does not accept a number with more than ten digits by typing in a twelve digit number and ensuring an error message appears, when the form is sent, instructing the admin users not to use a number with more than ten digits.
...
- Enter the Slurps website and log in using the superuser username “__*Admin*__” and its password and ensure the “__*Admin*__” user is redirected to the home page with a message stating the “__*Admin*__” user is the one logged in.
- Click on the “__*Add Drink*__” link from the navigation bar and ensure the website redirects to the “__*Add Drink*__” page and view the “__*Add Drink*__” form.
- Using chrome development tools, check the “__*Add Drink*__” form’s responsiveness by changing the page’s screen size to: 320x571, 576x571, 768x571, 992x571 and 1200x571 and ensure the form remains clearly visible across all these screen sizes. 
- Add Drink Form:
    - Ensure the form contains the following fields with asterisks: “__*Image*__”, “__*Drink name*__”, “__*Price*__”, “__*Millilitres*__” and “__*Drink type*__”.
    - Ensure only the “__*Drink type*__” part of the form is filled in with a default value from one of the dropdown options and the other remaining fields are empty.
    - Click on the “__*Choose file*__” button and ensure an extension opens up and allows the admin users to select an image to be added for the drink. 
    - Select an image from the opened up extension and ensure a message under the “__*Image*__” section of the form appears; informing the admin users the name of the image they selected.
    - Ensure the “__*Drink name*__” input capitalises every word typed in the field by typing a list of words in lowercase. Ensure all these words still start with a capital letter each.
    - Check the “__*Price*__” and “__*Millilitres*__” fields accept only numbers in them by typing in letters and ensuring they do not show in the field.
    - Check the “__*Price*__” field does not accept a number with more than ten digits by typing in a twelve digit number and ensuring an error message appears, when the form is sent, instructing the admin users not to use a number with more than ten digits.
    - Check the “__*Drink type*__” part of the form provides dropdown options for admin users to choose from the following: “__*New Drinks*__”, “__*Juices*__” and “__*Milkshakes*__”.
- Cancel Button:
    - Hover over the “__*CANCEL*__” button to ensure its outline colour changes to “__*#17a2b8*__”.
    - Click on the button to check the page redirects back to the admin home page and check that there are no new drinks present to ensure the “__*CANCEL*__” button works at ceasing the act of adding new drinks.
- Add Drink Button:
    - Hover over the “__*ADD DRINK*__” button to ensure its outline colour changes to “__*#17a2b8*__”.
    - To ensure all the form fields are required, click the “__*ADD DRINK*__” button with all the fields being empty to elicit an error message informing the admin users that all parts of the form are required to be completed before submission.
    - Fill in the “__*Add Drink*__” fields of the form then click the “__*ADD DRINK*__” button to make sure the page reloads and appears with the message “__*Drink successfully added!*__” above the form.
...
- Directories of Jasmine test files:
    - [**_slurps.js_**](jasmineTesting/scripts/slurps.js)
    - [**_slurpsSpec.js_**](jasmineTesting/spec/slurpsSpec.js)
    - [**_jasmineTesting.html_**](jasmineTesting/jasmineTesting.html)
## Python Unit testing
...
10. To connect “__*Django*__” to “__*S3*__”, create an if statement where if “__*USE_AWS*__ __*in os.environ:*__”, is fulfilled then the following are produced: 
